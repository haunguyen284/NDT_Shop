...
public class DialogMauSac extends javax.swing.JDialog {
    ...
    public MauSacDTO selectedMauSac;
    ...
    private void loadDataTable() {
        ...
        for (MauSacDTO dto : listDTO) {
            tbHienThi.addRow(new Object[]{
                dto.getId(),
                dto.getMa(),
                dto.getTen(),
                dto.getTrangThaiMauSac() == TrangThaiMauSac.ACTIVE ? "ACTIVE" : "IN ACTIVE"
            });
        }
    }
    ...
    private MauSacDTO getDTOFromInput() {
        MauSacDTO dto = new MauSacDTO();
        String ma = txtMa.getText();
        String ten = txtTen.getText();
        TrangThaiMauSac trangThai = TrangThaiMauSac.IN_ACTIVE;
        if (cbbTrangThai.getSelectedIndex() == 0) {
            trangThai = TrangThaiMauSac.ACTIVE;
        }
        dto.setMa(ma);
        dto.setTen(ten);
        dto.setTrangThaiMauSac(trangThai);
        return dto;
    }
