...
public class DialogThuongHieu extends javax.swing.JDialog {
    ...
    public ThuongHieuDTO selectedThuongHieu;
    ...
    private void loadDataTable() {
        ...
        for (ThuongHieuDTO dto : listDTO) {
            tbHienThi.addRow(new Object[]{
                dto.getId(),
                dto.getMa(),
                dto.getTen(),
                dto.getTrangThaiThuongHieu() == TrangThaiThuongHieu.ACTIVE ? "ACTIVE" : "IN ACTIVE"
            });
        }
    }
    ...
    private ThuongHieuDTO getDTOFromInput() {
        ThuongHieuDTO dto = new ThuongHieuDTO();
        String ma = txtMa.getText();
        String ten = txtTen.getText();
        TrangThaiThuongHieu trangThai = TrangThaiThuongHieu.IN_ACTIVE;
        if (cbbTrangThai.getSelectedIndex() == 0) {
            trangThai = TrangThaiThuongHieu.ACTIVE;
        }
        dto.setMa(ma);
        dto.setTen(ten);
        dto.setTrangThaiThuongHieu(trangThai);
        return dto;
    }
    ...
    private void btnChonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonActionPerformed
        ...
        selectedThuongHieu.setId(selectedId);
        this.dispose();
